...
export default function Index() {
  ...
  const destinations = [
    ...
    { name: 'Нью-Йорк', country: 'США', price: '120 000 ₽', image: '/placeholder.svg' },
    { name: 'Париж', country: 'Франция', price: '95 000 ₽', image: '/placeholder.svg' },
    { name: 'Дубай', country: 'ОАЭ', price: '75 000 ₽', image: '/placeholder.svg' },
    { name: 'Сингапур', country: 'Сингапур', price: '110 000 ₽', image: '/placeholder.svg' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-muted to-blue-50">
      ...
      <section id="destinations" className="py-20 px-4 bg-white/50">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Исследуйте мир с комфортом и стилем</p>
          </div>
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">AI Trip Finder</h2>
            <p className="text-muted-foreground text-lg">Умный поиск идеального путешествия</p>
          </div>
          <Card className="max-w-4xl mx-auto glass border-2 border-primary/20 glow p-8">
              ...
              <Card key={idx} className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 border-2 border-border/50 hover:border-primary/50 glow-hover">
                ...
                <CardContent className="p-8">
                  ...
                  <div className="flex items-end justify-between">
                    ...
                    <Button className="glow-hover">Бронировать</Button>
                  </div>
                </CardContent>
              </Card>
            ))}
